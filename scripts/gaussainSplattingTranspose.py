...
if __name__ == "__main__":
    ...
    Tmat = np.array([
        [0.962571680546, -0.271027147770, 0.000000000000, -0.252573071476],
        [0.271027147770,  0.962571680546, 0.000000000000, -0.167772854293],
        [0.000000000000,  0.000000000000, 1.000000000000,  0.953991755843],
        [0.000000000000,  0.000000000000, 0.000000000000,  1.000000000000],
    ])

    Tmat = np.eye(4)
    # Tmat[:3,:3] = Rotation.from_euler('xyz', [0, 180, 0], degrees=True).as_matrix()
    Tmat[1,3] = -0.1

    # Tmat = np.array([
    #     [ 0.999920296778, 0.011921580163, -0.004156443043, -0.005039701315],
    #     [-0.011936456447, 0.999922374882, -0.003572844422, -0.013825706273],
    #     [ 0.004113526447, 0.003622172856,  0.999984979269, -0.023573247648],
    #     [ 0.000000000000, 0.000000000000,  0.000000000000,  1.000000000000],
    # ])
